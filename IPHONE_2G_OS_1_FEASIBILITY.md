...
> `ipod_touch_1g-qemu6-legacy` at `4221943495`. This is the original feasibility
> analysis; see [`IPHONE_2G.md`](IPHONE_2G.md) and
> [`IPHONE_2G_BRINGUP_HANDOFF.md`](IPHONE_2G_BRINGUP_HANDOFF.md) for the current
> implementation and bring-up state.
