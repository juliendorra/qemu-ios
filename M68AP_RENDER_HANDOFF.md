...
| T7 | ~~N45AP: slide-to-unlock dies after the first sleep/wake cycle~~ | The multitouch model had no SPI transaction framing, so any short transfer desynced it permanently. Framed on `R_RXCNT` reaching 0. | **DONE** (2026-07-25) — 4/4 cycles unlock; full write-up incl. six dead ends in `M68AP_HOMESCREEN_CASE_STUDY.md` |
